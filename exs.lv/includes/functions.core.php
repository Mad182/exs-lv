...
function update_awards($user) {
	...
	if (in_array($user, array(13004,2101,23282,23678,1,273,7141,140,11525,12108,10578,26777,6890,25892,26070,28463,13059,22518,12696,19504,8427,4432,21805,20858,870,16395,115,10065))) {
