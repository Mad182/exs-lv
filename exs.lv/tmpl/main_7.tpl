...
<head>
	<meta charset="UTF-8">
		...
		<!-- END BLOCK : guest-js -->
		<!-- START BLOCK : user-js -->
		<script src="{static-server}/js/jquery.min.js,tinycon.min.js,jquery.cookie.js,jquery.fancybox.js,jquery.raty.min.js,jquery.cycle.js,mcp.js,j.js?v={css-version}"></script>
		<!-- END BLOCK : user-js -->
