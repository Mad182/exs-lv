...
<body class="{layout-options}">
	<div id="wrapper">
					...
					<li{profile-sel}>
						...
						<li{cat-sel-104}><a href="/pm">Vēstules<span id="new-msg">{new-messages}</span></a></li>
							...
							<li{mb-sel}><a href="/say/{currentuser-id}">Miniblogs</a></li>
								<li{cat-sel-585}><a class="notes" href="/piezimes"><img
											src="{img-server}/bildes/fugue-icons/notebook.png" alt="Piezīmes" /></a>
									</li>
				...
				<form id="login-form" action="{page-url}" method="post">
					<fieldset>
						...
						<span{cat-sel-106}><a href="/register">Reģistrēties</a></span>
							...
							<label><input name="login-submit" id="login-submit" class="login-submit" value="Ienākt"
									type="submit" /></label>
							<label><a href="/gmail-login" class="gmail-login-btn" title="Ienākt ar Gmail / Google"><svg width="14" height="14" viewBox="0 0 24 24" style="vertical-align: -2px; margin-right: 4px;"><path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/><path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/><path fill="#FBBC05" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.06H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.94l2.85-2.22.81-.63z"/><path fill="#EA4335" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.06l3.66 2.84c.87-2.6 3.3-4.52 6.16-4.52z"/></svg>Gmail</a></label>
					</fieldset>
				</form>
		...
		<div class="mbox {class}" id="flash-message">
			<p><a id="close-flash-message" href="#"><img src="{img-server}/bildes/fugue-icons/cross-button.png"
						alt="Aizvērt" title="Aizvērt" width="16" height="16" /></a> {message}</p>
		</div>
		<div class="c"></div>
		...
		<div id="right">
			...
			<div id="inner-sidebar">
				...
				<div class="box">
					<ul class="tabs">
						<li><a href="/latest.php" class="active remember-pages ajax"><span
			...
			<div id="inner-content">
				...
				<ul class="tabs">
					<li><a href="/user/{user-id}" class="{active-tab-profile}"><span
								class="profile user-level-{inprofile-level} user-gender-{inprofile-gender}">Profils</span></a>
					</li>
		...
		<footer id="footer">
			<div id="online-users">
				...
				Lapu šobrīd skatās {page-onlinetotal} lietotāji, no tiem reģistrētie:<br><span
					style="font-size:10px">{page-onlineusers}</span>
			</div>
