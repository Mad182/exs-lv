...
<div id="wrapper">
	<div id="header">
		...
		<a id="logo" href="/" title="Online animated GIF tools">
			ezGif.com
		...
		<ul id="top-menu">
			...
			<li{cat-sel-1254}><a class="effects" href="/effects" title="Add effects to animation">GIF Effects</a></li>
	...
	<div id="content">
		...
		<div id="main">
			...
			<div class="mbox {class}" id="flash-message"><p>{message}</p></div>
			<div class="clear"></div>
	...
	<div id="share">
		...
		<iframe src="//www.facebook.com/plugins/like.php?href=http%3A%2F%2Fezgif.com%2F&amp;send=false&amp;layout=button_count&amp;width=90&amp;show_faces=false&amp;font&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=423445844398591" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:90px; height:21px;" allowTransparency="true"></iframe>
<script type="text/javascript">
  (function() {
...
<script type="text/javascript">
	...
	var _gaq = _gaq || [];
	_gaq.push(['_setAccount', 'UA-205489-8']);
