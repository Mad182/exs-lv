...
<html lang="lv">
	<head>
		...
		<link rel="stylesheet" href="{static-server}/css/bootstrapped.css{add-css}?{page-time}" type="text/css" />
		...
		<script type="text/javascript" src="{static-server}/js/tinycon.min.js{jquery-tools},jquery.cookie.js,jquery.fancybox.js,jquery.raty.min.js,swfobject.js,bootstrapped.js"></script>
