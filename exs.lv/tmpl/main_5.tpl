...
<html lang="lv">
	<head>
		...
		<link rel="stylesheet" href="{static-server}/css/core.css,mta.css" type="text/css">
		<!-- START BLOCK : additional-css-->
		<link rel="stylesheet" href="{static-server}/css/{filename}" type="text/css">
		<!-- END BLOCK : additional-css-->
		<script type="text/javascript" src="{static-server}/js/jquery.min.js,tinycon.min.js,jquery.cookie.js,jquery.fancybox.js,jquery.raty.min.js,mcp.js,j.js"></script>
			...
			<div id="header">
				...
				<div id="top-menu">
					...
					<ul id="top-menu-right">
						...
						<li>
							<a class="external-login external-dr" title="Ienākt ar draugiem.lv pasi" href="https://api.draugiem.lv/authorize/?app=15005147&amp;hash=ff83ad63d2df3efc955e0b03421344ef&amp;redirect=https%3A%2F%2Frp.exs.lv%2Fdraugiem-signup%2F" onclick="if(handle=window.open('https://api.draugiem.lv/authorize/?app=15005147&amp;hash=ff83ad63d2df3efc955e0b03421344ef&amp;redirect=https%3A%2F%2Frp.exs.lv%2Fdraugiem-signup%2F&amp;popup=1','Dr_15005147' ,'width=400, height=400, left='+(screen.width?(screen.width-400)/2:0)+', top='+(screen.height?(screen.height-400)/2:0)+',scrollbars=no')){handle.focus();return false;}"><span>Ienākt</span></a>
						</li>
						<li>
