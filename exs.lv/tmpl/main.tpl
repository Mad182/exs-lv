...
<div id="header"{page-persona}>
	...
	<img src="/bildes/ball.png" width="40" height="40" id="ball" style="display:none;">
	...
	var to = document.getElementById('header').clientHeight - img.clientHeight - document.getElementById('top-menu').clientHeight + 6;
	var width  = 120 + Math.floor((Math.random()*700)+1);;
