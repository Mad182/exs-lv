...
<script type="text/javascript" src="/js/jquery.min.js{jquery-tools},redactor.js,tinycon.min.js,jquery.cookie.js,jquery.fancybox-1.3.4.pack.js,jquery.raty.min.js,swfobject.js,j.js"></script>
...
<div id="logo">
	...
	<div id="tools-bar">
		<ul id="site-links">
			...
			<li><a href="http://code.exs.lv/" title="Mājas lapu veidošanas un programmēšanas forums">code.exs.lv</a></li>
