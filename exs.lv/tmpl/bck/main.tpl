...
<link rel="stylesheet" href="/css/core.css{add-css},skin{page-skinid}.css?7" type="text/css" />
...
<div id="logo">
	...
	<div id="tools-bar">
		<ul id="site-links">
			...
			<li><a href="http://m.exs.lv/" title="Mobilā versija">Mobilā versija</a></li>
			...
			<li><a href="/tag">Tagi</a></li>
			<li><a href="/read/lietosanas-noteikumi">Noteikumi</a></li>
			<li><a href="/statistika">Stati</a></li>
			<li><a href="/servers" title="Latvijas Counter Strike serveru saraksts">Serveri</a></li>
...
<div id="top-menu">
	...
	<ul id="top-menu-right">
		...
		<li{cat-sel-585}><a href="/piezimes"><img src="http://exs.lv/bildes/fugue-icons/notebook.png" alt="Piezīmes" /></a></li>
	...
	<form id="login-form" action="http://exs.lv{page-url}" method="post">
		<fieldset>
			...
			<a href="http://api.draugiem.lv/authorize/?app=15005147&amp;hash=291e891358c8819a234e6d96b3a0d449&amp;redirect=http%3A%2F%2Fexs.lv%2Fdraugiem-signup%2F" onclick="if(handle=window.open('http://api.draugiem.lv/authorize/?app=15005147&amp;hash=291e891358c8819a234e6d96b3a0d449&amp;redirect=http%3A%2F%2Fexs.lv%2Fdraugiem-signup%2F&amp;popup=1','Dr_15005147' ,'width=400, height=400, left='+(screen.width?(screen.width-400)/2:0)+', top='+(screen.height?(screen.height-400)/2:0)+',scrollbars=no')){handle.focus();return false;}"><img border="0" src="/bildes/pase.png" alt="draugiem.lv pase" /></a>
			<!--<a href="https://www.facebook.com/login.php?api_key=353222841436117&cancel_url=http%3A%2F%2Fexs.lv%2Ffb-login&display=page&fbconnect=1&next=http%3A%2F%2Fexs.lv%2Ffb-login%2Flogin&return_session=1&session_version=3&v=1.0"><img src="http://exs.lv/bildes/fb-login.png" alt="login with facebook" /></a>-->
		</fieldset>
	</form>
...
<div class="box">
	<ul class="shadetabs mbox">
		<li><a href="/latest.php" class="{pages-selected}remember-pages"><span class="comments">Raksti</span></a></li>
		<li><a href="/latest.php?type=images" class="{gallery-selected}remember-gallery"><span class="gallery">Bildes</span></a></li>
	</ul>
	<div class="c"></div>
...
<div class="box monitor">
	<ul class="shadetabs mbox">
		<li><a href="/cache/cs_monitor.html" class="selected remember-cs"><span class="game-cs">Counter Strike</span></a></li>
	</ul>
...
<div class="box monitor">
        <ul class="shadetabs mbox">
                <li><a href="/cache/mc_monitor.html" class="selected remember-mc"><span class="game-mc">MineCraft</span></a></li>
        </ul>
...
<div class="box">
	<ul class="shadetabs mbox">
		<li><a href="/fact" class="{fact-all-selected}remember-fact-all"><span class="fact-all">Spēles</span></a></li>
		<li><a href="/fact/rs" class="{fact-rs-selected}remember-fact-rs"><span class="fact-rs">RS</span></a></li>
	</ul>
	<div class="c"></div>
...
<ul id="external-links">
	...
	<li><a href="http://ezgif.com/">Edit animated gifs online</a></li>
</ul>
</div>
<div class="c"></div>
</div>
...
<script type="text/javascript">stLight.options({publisher: "4d98a7e5-1431-418b-9bba-687f99a50a3f"}); </script>
<!-- END BLOCK : sharethis-->
</body>
</html>
