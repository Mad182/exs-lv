...
<div class="game-seo-box" style="margin-top: 30px; padding: 20px; background: #ffffff; border: 1px solid #e2e8f0; border-radius: 8px;">
	<h2 style="margin-top: 0; color: #0f172a; font-size: 20px;">Par Atmiņas spēli (Memory) un kā spēlēt</h2>
	<div style="display: flex; gap: 20px; flex-wrap: wrap; margin-top: 15px;">
		...
		<div style="width: 300px; max-width: 100%;">
			<img src="/bildes/speles/memory.png" alt="Atmiņas spēle EXS.LV" style="width: 100%; border-radius: 6px; box-shadow: 0 2px 8px rgba(0,0,0,0.15);" />
		</div>
	</div>
</div>
<!-- END BLOCK : seo-text -->
