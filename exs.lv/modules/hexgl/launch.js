...
(function() {
  ...
  s = [['controlType', ['KEYBOARD', 'TOUCH', 'LEAP MOTION CONTROLLER', 'GAMEPAD'], defaultControls, defaultControls, 'Vadība: '], ['quality', ['LOW', 'MID', 'HIGH', 'VERY HIGH'], 3, 3, 'Kvalitāte: '], ['hud', ['OFF', 'ON'], 1, 1, 'HUD: '], ['godmode', ['OFF', 'ON'], 0, 1, 'Godmode: ']];
  ...
  if (startBtn) {
    if (!hasWebGL()) {
      startBtn.innerHTML = 'WebGL is not supported!';
      ...
      startBtn.onclick = function() {
        ...
        return $('step-2').style.backgroundImage = "url(/modules/hexgl/css/help-" + s[0][3] + ".png)";
      };
    }
  }
