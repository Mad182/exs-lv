...
// detalizēta statistika ar daudziem pieprasījumiem un atgrieztiem skaitļiem,
// kas ikgadēji tiek publicēti lapā
if (isset($_GET['var1']) && $_GET['var1'] === 'detailed') {
    
    $include_check = true;
    require(CORE_PATH.'/modules/'.$category->module.'/statistics.php');
