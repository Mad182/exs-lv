...
define('ADMIN_USERNAME','mad182'); 	// Admin Username
define('ADMIN_PASSWORD','mc');  	// Admin Password
...
span.red_bg { background:#D06030; padding:0 0.5em 0 0.5em }
...
EOB;
	...
	echo
		...
		'</tr>',
		'<tr>',
		'<td class=td-0><span class="red_bg box">&nbsp;</span>Used: ',bsize($mem_used ).sprintf(" (%.1f%%)",$mem_used *100/$mem_size),"</td>\n",
		'<td class=td-1><span class="red_bg box">&nbsp;</span>Misses: ',$misses.sprintf(" (%.1f%%)",$misses*100/($hits+$misses)),"</td>\n";
		echo <<< EOB
	</tr>
	</tbody></table>
<br/>
