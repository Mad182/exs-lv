...
<?
$res = mysql_query("SELECT * FROM league_nhl_po_statistics WHERE pos = 'Player' AND league_id = '" . LEAGUE_ID . "' ORDER BY goal + asst DESC LIMIT 0,1");
...
$res1 = mysql_query("SELECT * FROM league_nhl_po_statistics WHERE pos = 'Player' AND league_id = '" . LEAGUE_ID . "' ORDER BY goal + asst DESC LIMIT 1,2");
...
$res2 = mysql_query("SELECT * FROM league_nhl_po_statistics WHERE pos = 'Player' AND league_id = '" . LEAGUE_ID . "'ORDER BY goal + asst DESC LIMIT 2,3");
...
$res3 = mysql_query("SELECT * FROM league_nhl_po_statistics WHERE pos = 'Player' AND league_id = '" . LEAGUE_ID . "'ORDER BY goal + asst DESC LIMIT 3,4");
...
$res4 = mysql_query("SELECT * FROM league_nhl_po_statistics WHERE pos = 'Player' AND league_id = '" . LEAGUE_ID . "' ORDER BY goal + asst DESC LIMIT 4,5");
...
{
echo 'NHL #' . LEAGUE_ID . ' līga vēl nav izspēlēta neviena playoff spēle,<br> tāpēc pašlaik nav statistikas ko ievākt!';
}
?>
</div>
...
<div class="box_content">
<?
$res = mysql_query("SELECT * FROM league_nhl_po_statistics WHERE pos = 'Player' AND league_id = '" . LEAGUE_ID . "' ORDER BY goal DESC LIMIT 0,1");
$row=mysql_fetch_array($res);
$points = $row['goal'] + $row['asst'];
$izvelk_player = mysql_query("SELECT * FROM league_nhl_players WHERE player_name = '$row[player_name]'");
$player_name = mysql_fetch_array($izvelk_player); 
...
$res1 = mysql_query("SELECT * FROM league_nhl_po_statistics WHERE pos = 'Player' AND league_id = '" . LEAGUE_ID . "' ORDER BY goal DESC LIMIT 1,2");
$row1 = mysql_fetch_array($res1);
$points1 = $row1['goal'] + $row1['asst'];
$sekundes1 = $row1['time']/$row1['gp'];
$min1 = floor($sekundes1/60);
...
$res2 = mysql_query("SELECT * FROM league_nhl_po_statistics WHERE pos = 'Player' AND league_id = '" . LEAGUE_ID . "' ORDER BY goal DESC LIMIT 2,3");
$row2=mysql_fetch_array($res2);
$points2 = $row2['goal'] + $row2['asst'];
$sekundes2 = $row2['time']/$row2['gp'];
$min2 = floor($sekundes2/60);
...
$res3 = mysql_query("SELECT * FROM league_nhl_po_statistics WHERE pos = 'Player' AND league_id = '" . LEAGUE_ID . "' ORDER BY goal DESC LIMIT 3,4");
$row3=mysql_fetch_array($res3);
$points3 = $row3['goal'] + $row3['asst'];
$sekundes3 = $row3['time']/$row3['gp'];
$min3 = floor($sekundes3/60);
...
$res4 = mysql_query("SELECT * FROM league_nhl_po_statistics WHERE pos = 'Player' AND league_id = '" . LEAGUE_ID . "' ORDER BY goal DESC LIMIT 4,5");
$row4=mysql_fetch_array($res4);
$points4 = $row4['goal'] + $row4['asst'];
$sekundes4 = $row4['time']/$row4['gp'];
$min4 = floor($sekundes4/60);
...
<div class="box_content">
<?
$res = mysql_query("SELECT * FROM league_nhl_po_statistics WHERE pos = 'Player' AND league_id = '" . LEAGUE_ID . "' ORDER BY asst DESC LIMIT 0,1");
$row=mysql_fetch_array($res);
$points = $row['goal'] + $row['asst'];
$izvelk_player = mysql_query("SELECT * FROM league_nhl_players WHERE player_name = '$row[player_name]'");
$player_name = mysql_fetch_array($izvelk_player); 
...
$res1 = mysql_query("SELECT * FROM league_nhl_po_statistics WHERE pos = 'Player' AND league_id = '" . LEAGUE_ID . "' ORDER BY asst DESC LIMIT 1,2");
$row1 = mysql_fetch_array($res1);
$points1 = $row1['goal'] + $row1['asst'];
$sekundes1 = $row1['time']/$row1['gp'];
$min1 = floor($sekundes1/60);
...
$res2 = mysql_query("SELECT * FROM league_nhl_po_statistics WHERE pos = 'Player' AND league_id = '" . LEAGUE_ID . "' ORDER BY asst DESC LIMIT 2,3");
$row2=mysql_fetch_array($res2);
$points2 = $row2['goal'] + $row2['asst'];
$sekundes2 = $row2['time']/$row2['gp'];
$min2 = floor($sekundes2/60);
...
$res3 = mysql_query("SELECT * FROM league_nhl_po_statistics WHERE pos = 'Player' AND league_id = '" . LEAGUE_ID . "' ORDER BY asst DESC LIMIT 3,4");
$row3=mysql_fetch_array($res3);
$points3 = $row3['goal'] + $row3['asst'];
$sekundes3 = $row3['time']/$row3['gp'];
$min3 = floor($sekundes3/60);
...
$res4 = mysql_query("SELECT * FROM league_nhl_po_statistics WHERE pos = 'Player' AND league_id = '" . LEAGUE_ID . "' ORDER BY asst DESC LIMIT 4,5");
$row4=mysql_fetch_array($res4);
$points4 = $row4['goal'] + $row4['asst'];
$sekundes4 = $row4['time']/$row4['gp'];
$min4 = floor($sekundes4/60);
...
<div class="box_content">
<?
$res = mysql_query("SELECT * FROM league_nhl_po_statistics WHERE pos = 'Player' AND league_id = '" . LEAGUE_ID . "' ORDER BY hits DESC LIMIT 0,1");
$row=mysql_fetch_array($res);
$points = $row['goal'] + $row['asst'];
$izvelk_player = mysql_query("SELECT * FROM league_nhl_players WHERE player_name = '$row[player_name]'");
$player_name = mysql_fetch_array($izvelk_player); 
...
$res1 = mysql_query("SELECT * FROM league_nhl_po_statistics WHERE pos = 'Player' AND league_id = '" . LEAGUE_ID . "' ORDER BY hits DESC LIMIT 1,2");
$row1 = mysql_fetch_array($res1);
$points1 = $row1['goal'] + $row1['asst'];
$sekundes1 = $row1['time']/$row1['gp'];
$min1 = floor($sekundes1/60);
...
$res2 = mysql_query("SELECT * FROM league_nhl_po_statistics WHERE pos = 'Player' AND league_id = '" . LEAGUE_ID . "' ORDER BY hits DESC LIMIT 2,3");
$row2=mysql_fetch_array($res2);
$points2 = $row2['goal'] + $row2['asst'];
$sekundes2 = $row2['time']/$row2['gp'];
$min2 = floor($sekundes2/60);
...
$res3 = mysql_query("SELECT * FROM league_nhl_po_statistics WHERE pos = 'Player' AND league_id = '" . LEAGUE_ID . "' ORDER BY hits DESC LIMIT 3,4");
$row3=mysql_fetch_array($res3);
$points3 = $row3['goal'] + $row3['asst'];
$sekundes3 = $row3['time']/$row3['gp'];
$min3 = floor($sekundes3/60);
...
$res4 = mysql_query("SELECT * FROM league_nhl_po_statistics WHERE pos = 'Player' AND league_id = '" . LEAGUE_ID . "' ORDER BY hits DESC LIMIT 4,5");
$row4=mysql_fetch_array($res4);
$points4 = $row4['goal'] + $row4['asst'];
$sekundes4 = $row4['time']/$row4['gp'];
$min4 = floor($sekundes4/60);
...
<div class="box_content">
<?
$res = mysql_query("SELECT * FROM league_nhl_po_statistics WHERE pos = 'Player' AND league_id = '" . LEAGUE_ID . "' ORDER BY plus_minus DESC LIMIT 0,1");
$row=mysql_fetch_array($res);
$points = $row['goal'] + $row['asst'];
$izvelk_player = mysql_query("SELECT * FROM league_nhl_players WHERE player_name = '$row[player_name]'");
$player_name = mysql_fetch_array($izvelk_player); 
...
$res1 = mysql_query("SELECT * FROM league_nhl_po_statistics WHERE pos = 'Player' AND league_id = '" . LEAGUE_ID . "' ORDER BY plus_minus DESC LIMIT 1,2");
$row1 = mysql_fetch_array($res1);
$points1 = $row1['goal'] + $row1['asst'];
$sekundes1 = $row1['time']/$row1['gp'];
$min1 = floor($sekundes1/60);
...
$res2 = mysql_query("SELECT * FROM league_nhl_po_statistics WHERE pos = 'Player' AND league_id = '" . LEAGUE_ID . "' ORDER BY plus_minus DESC LIMIT 2,3");
$row2=mysql_fetch_array($res2);
$points2 = $row2['goal'] + $row2['asst'];
$sekundes2 = $row2['time']/$row2['gp'];
$min2 = floor($sekundes2/60);
...
$res3 = mysql_query("SELECT * FROM league_nhl_po_statistics WHERE pos = 'Player' AND league_id = '" . LEAGUE_ID . "' ORDER BY plus_minus DESC LIMIT 3,4");
$row3=mysql_fetch_array($res3);
$points3 = $row3['goal'] + $row3['asst'];
$sekundes3 = $row3['time']/$row3['gp'];
$min3 = floor($sekundes3/60);
...
$res4 = mysql_query("SELECT * FROM league_nhl_po_statistics WHERE pos = 'Player' AND league_id = '" . LEAGUE_ID . "' ORDER BY plus_minus DESC LIMIT 4,5");
$row4=mysql_fetch_array($res4);
$points4 = $row4['goal'] + $row4['asst'];
$sekundes4 = $row4['time']/$row4['gp'];
$min4 = floor($sekundes4/60);
...
<div class="box_content">
<?
$res = mysql_query("SELECT * FROM league_nhl_po_statistics WHERE pos = 'Goalie' AND gp >= 1 AND league_id = '" . LEAGUE_ID . "' ORDER BY ppg_ga / gp ASC LIMIT 0,1");
$row=mysql_fetch_array($res);
...
$res1 = mysql_query("SELECT * FROM league_nhl_po_statistics WHERE pos = 'Goalie' AND gp >= 1 AND league_id = '" . LEAGUE_ID . "' ORDER BY ppg_ga / gp ASC LIMIT 1,2");
$row1 = mysql_fetch_array($res1);
...
$res2 = mysql_query("SELECT * FROM league_nhl_po_statistics WHERE pos = 'Goalie' AND gp >= 1 AND league_id = '" . LEAGUE_ID . "' ORDER BY ppg_ga / gp ASC LIMIT 2,3");
$row2=mysql_fetch_array($res2);
...
$res3 = mysql_query("SELECT * FROM league_nhl_po_statistics WHERE pos = 'Goalie' AND gp >= 1 AND league_id = '" . LEAGUE_ID . "' ORDER BY ppg_ga / gp ASC LIMIT 3,4");
$row3=mysql_fetch_array($res3);
...
$res4 = mysql_query("SELECT * FROM league_nhl_po_statistics WHERE pos = 'Goalie' AND gp >= 1 AND league_id = '" . LEAGUE_ID . "' ORDER BY ppg_ga / gp ASC LIMIT 4,5");
$row4=mysql_fetch_array($res4);
...
<div class="box_content">
<?
$res = mysql_query("SELECT * FROM league_nhl_po_statistics WHERE pos = 'Goalie' AND gp >= 1 AND league_id = '" . LEAGUE_ID . "' ORDER BY ppg_ga / shot_sa ASC LIMIT 0,1");
$row=mysql_fetch_array($res);
$goalies_stats_average = number_format($row['ppg_ga'] / $row['gp'], 2);
$stats_procents = round(($row['ppg_ga'] / $row['shot_sa']) * 100, 2);
$goalies_stats_procents = 100 - $stats_procents;
...
$res1 = mysql_query("SELECT * FROM league_nhl_po_statistics WHERE pos = 'Goalie' AND gp >= 1 AND league_id = '" . LEAGUE_ID . "' ORDER BY ppg_ga / shot_sa ASC LIMIT 1,2");
$row1 = mysql_fetch_array($res1);
$goalies_stats_average1 = number_format($row1['ppg_ga'] / $row1['gp'], 2);
$stats_procents1 = round(($row1['ppg_ga'] / $row1['shot_sa']) * 100, 2);
$goalies_stats_procents1 = 100 - $stats_procents1;
...
$res2 = mysql_query("SELECT * FROM league_nhl_po_statistics WHERE pos = 'Goalie' AND gp >= 1 AND league_id = '" . LEAGUE_ID . "' ORDER BY ppg_ga / shot_sa ASC LIMIT 2,3");
$row2=mysql_fetch_array($res2);
$goalies_stats_average2 = number_format($row2['ppg_ga'] / $row2['gp'], 2);
$stats_procents2 = round(($row2['ppg_ga'] / $row2['shot_sa']) * 100, 2);
$goalies_stats_procents2 = 100 - $stats_procents2;
...
$res3 = mysql_query("SELECT * FROM league_nhl_po_statistics WHERE pos = 'Goalie' AND gp >= 1 AND league_id = '" . LEAGUE_ID . "' ORDER BY ppg_ga / shot_sa ASC LIMIT 3,4");
$row3=mysql_fetch_array($res3);
$goalies_stats_average3 = number_format($row3['ppg_ga'] / $row3['gp'], 2);
$stats_procents3 = round(($row3['ppg_ga'] / $row3['shot_sa']) * 100, 2);
$goalies_stats_procents3 = 100 - $stats_procents3;
...
$res4 = mysql_query("SELECT * FROM league_nhl_po_statistics WHERE pos = 'Goalie' AND gp >= 1 AND league_id = '" . LEAGUE_ID . "' ORDER BY ppg_ga / shot_sa ASC LIMIT 4,5");
$row4=mysql_fetch_array($res4);
$goalies_stats_average4 = number_format($row4['ppg_ga'] / $row4['gp'], 2);
$stats_procents4 = round(($row4['ppg_ga'] / $row4['shot_sa']) * 100, 2);
$goalies_stats_procents4 = 100 - $stats_procents4;
...
<div class="box_content">
<?
$res = mysql_query("SELECT * FROM league_nhl_po_statistics WHERE pos = 'Player' AND league_id = '" . LEAGUE_ID . "' ORDER BY pims DESC LIMIT 0,1");
$row=mysql_fetch_array($res);
$points = $row['goal'] + $row['asst'];
$izvelk_player = mysql_query("SELECT * FROM league_nhl_players WHERE player_name = '$row[player_name]'");
$player_name = mysql_fetch_array($izvelk_player); 
...
$res1 = mysql_query("SELECT * FROM league_nhl_po_statistics WHERE pos = 'Player' AND league_id = '" . LEAGUE_ID . "' ORDER BY pims DESC LIMIT 1,2");
$row1 = mysql_fetch_array($res1);
$points1 = $row1['goal'] + $row1['asst'];
$sekundes1 = $row1['time']/$row1['gp'];
$min1 = floor($sekundes1/60);
...
$res2 = mysql_query("SELECT * FROM league_nhl_po_statistics WHERE pos = 'Player' AND league_id = '" . LEAGUE_ID . "' ORDER BY pims DESC LIMIT 2,3");
$row2=mysql_fetch_array($res2);
$points2 = $row2['goal'] + $row2['asst'];
$sekundes2 = $row2['time']/$row2['gp'];
$min2 = floor($sekundes2/60);
...
$res3 = mysql_query("SELECT * FROM league_nhl_po_statistics WHERE pos = 'Player' AND league_id = '" . LEAGUE_ID . "' ORDER BY pims DESC LIMIT 3,4");
$row3=mysql_fetch_array($res3);
$points3 = $row3['goal'] + $row3['asst'];
$sekundes3 = $row3['time']/$row3['gp'];
$min3 = floor($sekundes3/60);
...
$res4 = mysql_query("SELECT * FROM league_nhl_po_statistics WHERE pos = 'Player' AND league_id = '" . LEAGUE_ID . "' ORDER BY pims DESC LIMIT 4,5");
$row4=mysql_fetch_array($res4);
$points4 = $row4['goal'] + $row4['asst'];
$sekundes4 = $row4['time']/$row4['gp'];
$min4 = floor($sekundes4/60);
