...
// Update po standings
$db->query( "UPDATE league_nhl_po SET serie=serie+'".$w1."', hw=hw+'".$hw."', hl=hl+'".$hl."', hot=hot+'".$hot."' WHERE team = '" . $home_team . "' AND karta = '" . mysql_real_escape_string('1/2') . "' AND league_id = " . LEAGUE_ID );
$db->query( "UPDATE league_nhl_po SET serie=serie+'".$w2."', aw=aw+'".$aw."', al=al+'".$al."', aot=aot+'".$aot."' WHERE team = '" . $away_team . "' AND karta = '" . mysql_real_escape_string('1/2') . "' AND league_id = " . LEAGUE_ID );
