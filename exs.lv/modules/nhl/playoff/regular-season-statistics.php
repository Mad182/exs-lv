<center>	
		<input type="button" onclick="document.location='<?php echo BASE; ?>/league/<?php echo $row['league_id']; ?>/regular-season-statistics/';" class="login_button" value="Spēlētāju statistika"> - 
		<input type="button" onclick="document.location='<?php echo BASE; ?>/league/<?php echo $row['league_id']; ?>/regular-season-statistics/goalies/view/';" class="login_button" value="Vārtsargu statistika"> - 
		<input type="button" onclick="document.location='<?php echo BASE; ?>/league/<?php echo $row['league_id']; ?>/regular-season-statistics/top/';" class="login_button" value="Spēlētāju tops">
</center>
<?php
ini_set('display_errors', '0');
if( get_segment('goalies') )
{
	include ROOT . '/pages/league/NHL/playoff/regular-season-statistics/goalies.php';
}
elseif( get_segment('team') )
{
	include ROOT . '/pages/league/NHL/playoff/regular-season-statistics/team.php';
}
elseif( get_get('other') == 'top' )
{
	include ROOT . '/pages/league/NHL/playoff/regular-season-statistics/top.php';
}
else
{
?>
...
{
?>
<option value="<?php echo BASE ?>/league/<?php echo $row['league_id']; ?>/regular-season-statistics/team/<?php echo $team['team_small']; ?>/"><?php echo $team['team_full']; ?></option>
<?php
}
?>
</select>
...
<tr align="center" style="color:#E2E4E3; font-weight:bold;" bgcolor="#6F7070">
	<td width="1"><div id="stats_color"><a  href="<?php echo BASE ?>/league/<?php echo $row['league_id']; ?>/regular-season-statistics/sort/rank/<?php echo order_type('rank'); ?>">Rank</a></div></td>
	<td width="60"></td>
	<td width="30">Team</td>
	<td width="30"><div id="stats_color"><a href="<?php echo BASE ?>/league/<?php echo $row['league_id']; ?>/regular-season-statistics/sort/gp/<?php echo order_type('gp'); ?>/">GP</a></div></td>
	<td width="30"><div id="stats_color"><a href="<?php echo BASE ?>/league/<?php echo $row['league_id']; ?>/regular-season-statistics/sort/goals/<?php echo order_type('goals'); ?>/">GOALS</a></div></td>
	<td width="30"><div id="stats_color"><a href="<?php echo BASE ?>/league/<?php echo $row['league_id']; ?>/regular-season-statistics/sort/assists/<?php echo order_type('assists'); ?>/">ASSISTS</a></div></td>
	<td width="30"><div id="stats_color"><a href="<?php echo BASE ?>/league/<?php echo $row['league_id']; ?>/regular-season-statistics/sort/sa/<?php echo order_type('sa'); ?>/">SA%</a></div></td>
	<td width="30"><div id="stats_color"><a href="<?php echo BASE ?>/league/<?php echo $row['league_id']; ?>/regular-season-statistics/sort/points/<?php echo order_type('points'); ?>/">P</a></div></td>
	<td width="30"><div id="stats_color"><a href="<?php echo BASE ?>/league/<?php echo $row['league_id']; ?>/regular-season-statistics/sort/plusminus/<?php echo order_type('plusminus'); ?>/">+/-</a></div></td>
	<td width="30"><div id="stats_color"><a href="<?php echo BASE ?>/league/<?php echo $row['league_id']; ?>/regular-season-statistics/sort/shots/<?php echo order_type('shots'); ?>/">SHOTS</a></div></td>
	<td width="30"><div id="stats_color"><a href="<?php echo BASE ?>/league/<?php echo $row['league_id']; ?>/regular-season-statistics/sort/hits/<?php echo order_type('hits'); ?>/">HITS</a></div></td>
	<td width="30"><div id="stats_color"><a href="<?php echo BASE ?>/league/<?php echo $row['league_id']; ?>/regular-season-statistics/sort/ppg/<?php echo order_type('ppg'); ?>/">PPG</a></div></td>
	<td width="30"><div id="stats_color"><a href="<?php echo BASE ?>/league/<?php echo $row['league_id']; ?>/regular-season-statistics/sort/shg/<?php echo order_type('shg'); ?>/">SHG</a></div></td>
	<td width="30"><div id="stats_color"><a href="<?php echo BASE ?>/league/<?php echo $row['league_id']; ?>/regular-season-statistics/sort/pims/<?php echo order_type('pims'); ?>/">PIMS</a></div></td>
	<td width="30"><div id="stats_color"><a href="<?php echo BASE ?>/league/<?php echo $row['league_id']; ?>/regular-season-statistics/sort/toi/<?php echo order_type('toi'); ?>/">TOI</a></div></td>
</tr>
<?php
$count = $db->rows( $db->query("SELECT * FROM league_nhl_statistics WHERE pos = 'Player' AND league_id = '" . LEAGUE_ID . "'"));
$pager_link = get_segment('sort') ? '' . BASE . '/league/' . $row['league_id'] . '/regular-season-statistics/sort/'  . get_segment('sort') . '/' . order_type(get_get('id')) . '/page/':'' . BASE . '/league/' . $row['league_id'] . '/regular-season-statistics/page/';
...
echo '</table>';
if(!$count)
echo error("Līgā vēl nav izspēlēta neviena spēle, tāpēc pašlaik nav statistikas ko ievākt!", "892px");
if($count)
echo $pager;
}
?>