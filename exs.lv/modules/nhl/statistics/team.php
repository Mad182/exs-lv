...
<?php 
$team_e = $db->query('SELECT * FROM league_nhl_statistics WHERE team = "' . get_segment('team') . '"');
...
echo '</table>';
if(!$count)
echo error("Turnīrā ši komanda vēl nav izspēlējusi nevienu spēli, tāpēc nav statistikas ko ievākt!", "892px");
}
else
{
