...
$sec = $sekundes % 60;
$izvelk_player = mysql_query("SELECT * FROM league_nhl_players WHERE player_name = '".$goalies_statistic['player_name']."'");
...
echo '</table>';
if(!$count)
echo error("Turnīrā vēl nav izspēlēta neviena spēle, tāpēc pašlaik nav vārtsargu statistikas ko ievākt!", "892px");