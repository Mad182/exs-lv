...
<div class="tabMain">
	...
	<ul id="friends-pending">
		...
		<li>
			...
			<a href="?confirm={friend-id}">Apstiprināt</a> / <a href="?deny={friendship-id}">Noraidīt</a>
			<div class="c"></div>
		</li>
	...
	<ul id="friend-list">
		...
		<li><a class="profile-link" href="/user/{friend-id}"><img src="{friend-avatar}" alt="{friend-title}" /><br />{friend-nick}</a>
			...
			<a class="delete confirm" title="Pārtraukt draudzību" href="?deny={friendship-id}"><img src="http://exs.lv/bildes/x.png" alt="x" title="Pārtraukt draudzību" /></a>
