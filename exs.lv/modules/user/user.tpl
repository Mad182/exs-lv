	...
	<div id="year-stats-wrapper">
		...
		<div style="width: 10px;float: left;">
			...
			<div style="width: 9px;height: 10px;background: #fafafa;margin: 1px 1px 0 0">
				...
				<a class="cluetip cluetip-userprofile" style="float: left;width: 9px;height: 10px;background: #681e23;opacity:{decimal};filter:alpha(opacity={percent});" href="javascript:void(0)" title="{date} - {count} posti">&nbsp;</a>
