...
(function () {
	...
	if (theaterToggle) {
		theaterToggle.addEventListener('click', () => {
			document.querySelector('.ut99-wrapper').classList.toggle('theater-mode');
		});
	}
	...
	function renderDemoArena() {
		...
		canvas.addEventListener('mousedown', function onShoot() {
	...
	async function handleMatchEnd(frags, deaths) {
		...
		document.getElementById('ut99-final-frags').textContent = frags;
		document.getElementById('ut99-final-deaths').textContent = deaths;
		document.getElementById('ut99-final-kd').textContent = kd;
	...
	if (launchBotBtn) {
		launchBotBtn.addEventListener('click', () => {
			const map = document.getElementById('ut99-map-select').value;
			const botCount = document.getElementById('ut99-bot-count').value;
			const botSkill = document.getElementById('ut99-bot-skill').value;
			const fragLimit = document.getElementById('ut99-frag-limit').value;
