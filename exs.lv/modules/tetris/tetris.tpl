		...
		<div class="tetris-main-panel">
			<div class="tetris-game-row">
				...
				<div class="tetris-sidebar-panel">
					...
					<div class="tetris-controls-btns tetris-desktop-action-btns">
			...
			<div class="tetris-controls-row">
				...
				<div class="tetris-controls-btns tetris-mobile-action-btns">
					<button id="btn-pause-mobile" class="btn btn-warning" disabled>Nopauzēt (P)</button>
					<button id="btn-sound-mobile" class="btn btn-info">Skaņa: IESL.</button>
				</div>
			</div>
		</div>
	</div>
