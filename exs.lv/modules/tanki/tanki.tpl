<div class="tanki-wrapper">
	...
	<div class="tanki-game-layout">
		...
		<div class="tanki-main-stage">
			...
			<!-- POWER-UPS & ARSENAL GUIDE -->
			<div class="tanki-guide-container">
		...
		<div class="tanki-sidebar">
			<!-- TODAY LEADERBOARD -->
			<div class="tanki-leaderboard-box">
				<div class="leaderboard-header">
					<h3><span class="lb-icon">📅</span> Šodienas Tops</h3>
				</div>
			...
			<div class="tanki-leaderboard-box">
				<div class="leaderboard-header">
					<h3><span class="lb-icon">🏆</span> Visu Laiku Rekordi</h3>
				</div>
				<div class="leaderboard-content">
					<table class="table table-striped table-hover tanki-leaderboard-table">
						<thead>
