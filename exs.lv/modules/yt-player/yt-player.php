...
if(isset($_GET['var1']) && $_GET['var1'] === 'getnext') {
	...
	$song = array(
		...
		'html' => '<iframe width="560" height="315" src="//www.youtube.com/embed/'.$now_playing['id'].'?start='.$now_playing['position'].'&amp;autoplay=1" frameborder="0" allowfullscreen></iframe>'
	);
...
if(isset($_GET['var1']) && $_GET['var1'] === 'add') {
	...
	if(!empty($video->yt_time) && $video->yt_time != '0:00') {
