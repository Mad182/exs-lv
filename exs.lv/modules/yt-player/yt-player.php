...
if(isset($_GET['var1']) && $_GET['var1'] === 'getnext') {
	...
	$song = array(
		...
		'html' => '<iframe width="560" height="315" src="//www.youtube.com/embed/'.$now_playing['id'].'?start='.$now_playing['position'].'&amp;autoplay=1" frameborder="0" allowfullscreen></iframe><a style="float:right;" class="player-resubmit" href="/player/add/'.$now_playing['id'].'?_=1">+1 balss</a><div class="clear"></div>'
	);
