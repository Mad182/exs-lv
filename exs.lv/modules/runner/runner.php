...
if (isset($_GET['action']) && $_GET['action'] === 'push') {
	...
	if ($is_new_record) {
		push('Uzstādīja jaunu rekordu spēlē <a href="/runner">Bezgalīgais Bēdzējs</a> (' . number_format($highScore, 0, '', ' ') . ' m)', '/bildes/icons/award_star_gold_3.png', 'game-runner-' . $auth->id);
	}
