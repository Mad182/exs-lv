...
<p>
	...
	<a href="/?u={user-id}&amp;give=true" class="button primary" title="Dāvināt exs kredītus">Dāvināt expts</a>
	<!-- END BLOCK : user-profile-pm-->
	<!-- START BLOCK : user-profile-ban-->
	<a href="/?u={user-id}&amp;mode=block" class="button danger">Bloķēt lietotāju</a>
...
<dl id="profile-info" class="list-attr">
	<dt>Mājaslapa</dt><dd><a href="{user-web}" title="{user-nick} mājas lapa" rel="nofollow">{user-web}</a>&nbsp;</dd>
...
<div style="float:right;width:30%">
	...
	<div class="box">
		<ul class="small-userlist">
			...
			<li><a href="{url}" title="{viewer-nick} apskatījās {viewer-date}"><img src="/dati/bildes/{viewer-av-path}/{viewer-avatar}" alt="{viewer-nick}" width="45" height="45" /></a></li>
...
<form id="edit-profile" class="form" action="{page-url}" method="post" enctype="multipart/form-data">
	<fieldset>
		...
		<p><a href="/?u={user-id}&amp;buytitle=true"><strong>Vēlies nomainīt lietotāja nosaukumu?</strong></a></p>
		...
		<p>
			<label for="edit-rs_nick">Runescape niks:</label><br />
			<input type="text" class="text" name="edit-rs_nick" id="edit-rs_nick" value="{user-rs_nick}" maxlength="32" />
		</p>
		<p>
		...
		<p>
			<label for="edit-block_cs"><input type="checkbox" name="edit-block_cs" id="edit-block_cs"{edit-block_cs-mark} />ignorēt CS sadaļu</label>
		</p>
		<p>
			<label for="edit-avatar">Profila attēls (avatars): (<a href="http://exs.lv/Animacijas">Vēlies kustīgu?</a>)</label><br />
		...
		<p>
			...
			<select name="edit-skin" id="edit-skin">
				...
				<option value="2"{user-skin-2}>Blue</option>
				<option value="0"{user-skin-0}>Exs.lv old</option>
				<option value="5"{user-skin-5}>Metal (by Classified)</option>
...
<form id="give-profile" class="form" action="" method="post">
	<fieldset>
		...
		<!-- START BLOCK : give-tnx-->
		<p class="success">Pārskaitījums veikts!</p>
		<!-- END BLOCK : give-tnx-->
		<!-- START BLOCK : give-err-->
		<p class="error">Kļūda!</p>
		<!-- END BLOCK : give-err-->
		<p>
