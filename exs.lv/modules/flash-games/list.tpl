<!-- START BLOCK : games-list-->
<h1>{main-title}</h1>

<ul id="games-list-categories">
	<li><a href="/{category-url}/">Visas</a></li>
	<!-- START BLOCK : games-catlist-->
	<li><a href="/{category-url}/{slug}">{title}</a></li>
	<!-- END BLOCK : games-catlist-->
</ul>
<p class="core-pager">{pager-next} {pager-numeric} {pager-prev}</p>
<ul id="games-list">
	<!-- START BLOCK : games-node-->
	<li><a title="Spēlēt {alt}" href="/{category-url}/{slug}"><img src="{thumbnail}" width="93" height="74" alt="{alt}" /> {title} <span>{category}</span> <span>Reitings: {rating}</span></a></li>
	<!-- END BLOCK : games-node-->
</ul>
<div class="c"></div>
<p class="core-pager">{pager-next} {pager-numeric} {pager-prev}</p>
