...
<div class="right span5" id="home-middle">
	...
	<a id="frontage-banner" title="Interneta veikals BM.LV" href="https://bm.lv/" target="_blank" rel="nofollow" style="displan:block;padding:0"><img src="//img.exs.lv/m/a/mad/bm-lv.png" alt="bm.lv banner" style="width:66%;margin:12px auto 8px;display:block" /></a>
