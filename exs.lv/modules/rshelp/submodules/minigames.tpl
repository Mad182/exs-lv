...
<div class="rs-intro">
    <span class="vc-ghost-item"></span>
    <img id="logo-distractions" class="vc-item" src="{img-server}/bildes/runescape/intro/phoenix.png">
...
<ul class="stats-block">
    <li><img src="{img-server}/bildes/runescape/star-f2p.png" title="Bezmaksas versijas minispēle">&nbsp;{f2p-only}</li>
    <li><img src="{img-server}/bildes/runescape/star-p2p.png" title="Maksas versijas minispēle">&nbsp;{p2p-only}</li>
    <li><img src="{img-server}/bildes/runescape/safe.png" title="Droša minispēle">&nbsp;{safe}</li>
    <li><img src="{img-server}/bildes/runescape/unsafe.png" title="Bīstama minispēle">&nbsp;{unsafe}</li>
</ul>
    ...
    <tr>
        ...
        <td>
            <p>
                ...
                <img src="{img-server}/bildes/runescape/star-p2p-small.png" title="Pieejama tikai maksas spēlētājiem" alt="">
                <!-- END BLOCK : p2p-only -->
                <!-- START BLOCK : unsafe-minigame -->
                <img src="{img-server}/bildes/runescape/unsafe-small.png" title="Bīstama minispēle ar iespēju mirt" alt="">
...
<table class="rslist">
    ...
    <tr>
        <td class="mg-avatar">
            <img src="{img-server}/bildes/runescape/empty-2.png" title="Pamācība iztrūkst" alt="">
        </td>
        <td style="width:70%">
