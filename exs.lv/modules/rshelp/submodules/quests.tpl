...
<div id="series">
    ...
    <div class="series"{newline}>
        <h3>{series_title}</h3>
        <img src="{img-server}/bildes/runescape/series/{img}" title="{series_title}" alt="{series_title}">
...
<p class="simple-note">
    Neizdevās atlasīt sadaļas rakstus. Tādu, iespējams, nemaz nav!
</p>
...
<div id="skills-facts" style="font-size:13px">
    <ul>
        <li>Par īpašiem no kvestiem atalgojumā iegūstamiem priekšmetiem informācija meklējama <a href="http://runescape.wikia.com/wiki/Quest_item_rewards" rel="nofollow"><strong>šeit</strong></a>.</li>
        <li style="margin-bottom:20px">Par slēptajiem atalgojumiem daudzos kvestos informācija meklējama <a href="http://runescape.wikia.com/wiki/Quest_item_rewards/Hidden_rewards" rel="nofollow"><strong>šeit</strong></a>.</li>
        <li>Spēlētāji, kuri ir izgājuši visus kvestus, no Wise Old Man par 99k var nopirkt Quest Point Cape - vienu no <a rel="nofollow" href="http://runescape.wikia.com/wiki/Cape_of_Accomplishment">Capes of Accomplishment</a>.</li>
        <li>Spēlē tiekot izlaistam jaunam kvestam, Quest Cape nokļūst spēlētāja somā (vai bankā, ja soma pilna), līdz jaunais kvests netiek izpildīts.</li>
        <li>50. kvests - <a href="/read/legends-quest-2">Legends' Quest</a>, 100. kvests - <a href="/read/recipe-for-disaster-3">Recipe for Disaster</a>, 150. kvests - <a href="/read/chosen-commander-the">The Chosen Commander</a>, 200. kvests - <a rel="nofollow" href="http://runescape.wikia.com/wiki/Dimension_of_Disaster">Dimension of Disaster</a>.</li>        
        ...
        <li>Pirms <a rel="nofollow" href="http://runescape.wikia.com/wiki/Evolution_of_Combat">EoC</a> visu kvestu izpildīšanai bija nepieciešams vismaz 85. combat līmenis, bet, izejot tos, spēlētāja Combat pieauga līdz 105. līmenim.</li>
