...
<div class="rs-intro" style="margin-bottom:20px">
    ...
    ja tie sasnieguši noteiktu prasmes līmeni, izpildījuši grūtu kvestu vai sakrājuši noteiktu Quest Points skaitu.<br><span style="position:relative;top:8px">Katrai ģildei ir savas unikālās iespējas, ieskaitot vieglāku piekļuvi rīkiem un resursiem, kas veltīti attiecīgajai prasmei, un veikaliem, kuros pārdod citur nenopērkamus priekšmetus.</span></p>
</div>
