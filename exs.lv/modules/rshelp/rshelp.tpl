...
<h2 style="margin-top:-10px;margin-left:20px;">{category-title}</h2>
<table class="rslist" style="margin-left:20px;margin-right:20px;">
    <tr class="listhead">
    ...
    <tr>                 
        <td><img src="{img-server}/bildes/runescape/li.png" style="vertical-align:middle" alt=""></td>
...
<ul id="mainlist" class="rs-articles">
    ...
    <li>
        ...
        <div style="display:table">
            ...
            <div class="rs-article-img">
                <img class="av" style="max-height:70px" src="{img-server}/{image}">
            </div>
            <!-- END BLOCK : article-avatar -->
            <div class="rs-article-intro">
                {intro} 
