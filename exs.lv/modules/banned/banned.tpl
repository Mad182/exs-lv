...
<!-- START BLOCK : table-of-banned -->
	...
	<table class="table table-light" style="margin:0 auto;font-size:80%">
		...
		<tr>
			<td>{nick}<br />{banned-ip}&nbsp;<a title="Noņemt IP banu" class="red" href="/?c={category-id}&amp;delete_ip={banned-id}&amp;token={token}"><img src="{static-server}/bildes/x.png" alt="x" /></a></td>
