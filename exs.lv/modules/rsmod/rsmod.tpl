...
<ul class="tablist">
  ...
  <li><a href="/rsmod/st-order">storylainu dati</a></li>
  <li><a href="/rsmod/order">kvestu secība</a></li>
...
<ul class="tablist">
  ...
  <li><a href="/rsmod/aedit">activities</a></li>
  <li><a href="/rsmod/inpages">inpages</a></li>
</ul>
</div>
<!-- END BLOCK : rsmod-menu -->

<!-- START BLOCK : mod-cpanel -->
<div style="display:block;padding:20px;border:1px solid #ddd;float:right;margin:20px 50px 10px 0;width:80%">
	<form id="search-nick" action="" method="post">
		...
		<p style="border-bottom:2px solid #ddd;padding-bottom:10px">
			<input type="text" style="width:200px" name="nick" /> 
	...
	<form id="search-mail" action="" method="post">
		...
		<p style="border-bottom:2px solid #ddd;padding-bottom:10px">
			<input type="text" style="width:200px" name="mail" /> 
			<input type="submit" name="submit" class="danger button" value="Meklēt" />
		</p>
	</form>
	<form id="search-skype" action="" method="post">
		...
		<p style="border-bottom:2px solid #ddd;padding-bottom:10px">
			<input type="text" style="width:200px" name="ip" />		
			<input type="submit" name="submit" class="danger button" value="Meklēt" />
		</p>
	</form>
	...
	<table style="margin-top:20px;">
		...
		<tr>
			<td style="padding:3px 8px;border-bottom:1px dotted #ddd;width:120px;"><a href="/user/{id}">{nick}</a></td>
			<td style="padding:3px 8px;border-bottom:1px dotted #ddd;width:120px;">{lastip}</td>
			<td style="padding:3px 8px;border-bottom:1px dotted #ddd;width:100px;">{mail}</td>
			<td style="padding:3px 8px;border-bottom:1px dotted #ddd;width:70px;text-align:center">{karma}</td>
			<td style="padding:3px 8px;border-bottom:1px dotted #ddd;width:50px;text-align:center">{date}</td>
		</tr>
